function init() {
    for (var myLatlng = new google.maps.LatLng(11.997682, 121.915627), mapOptions = {
            zoom: 9,
            center: myLatlng,
            scrollwheel: !1,
            styles: [{
        ...
        }, mapElement = document.getElementById("map"), map = new google.maps.Map(mapElement, mapOptions), addresses = ["Brooklyn"], x = 0; x < addresses.length; x++) $.getJSON("http://maps.googleapis.com/maps/api/geocode/json?address=" + addresses[x] + "&sensor=false", null, function(data) {
...
function(e) {
    ...
    function() {
        ...
        var isiPad = function() {
            ...
            countDownDate = new Date("Apr 17, 2022 22:00:00").getTime(),
